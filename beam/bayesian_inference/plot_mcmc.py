...
DATA_FILE = "output_pints/mcmc_chains.npz"
TRUTH_FILE = "../damaged_system/StructuralMaterials.json"
OUTPUT_DIRECTORY = "output_pints"
ALGORITHM_LABEL = "PINTS random-walk Metropolis-Hastings"
...
def create_zone_figure(chains, acceptance_rates, reference_value,
    ...
    output_file = os.path.join(
        OUTPUT_DIRECTORY,
        f"pints_diagnostics_alpha_{zone_index + 1}.png")
